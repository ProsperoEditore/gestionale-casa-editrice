    ...
    <div class="container">
        ...
        <form method="POST" action="{{ route('report.dettagli.exportPdf', $report->id) }}" target="_blank" class="d-flex align-items-end gap-3 flex-wrap">
            ...
            @php
                ...
                $dataInizio = $dettagli->min('data') ? \Carbon\Carbon::parse($dettagli->min('data'))->format('Y-m-d') : '2022-01-01';
            @endphp
        ...
        <div class="table-responsive mt-4">
            <table class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="8">Nessun dato disponibile per questo report.</td>
                        </tr>
                    @endforelse
                </tbody>
                <tfoot>
